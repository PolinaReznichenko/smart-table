...
export function initData() {
  ...
  // Функция получения индексов (загружает справочники (продавцов, покупателей))
  ...
  // Функция получения записей о продажах с сервера (загружает записи с учётом параметров)
